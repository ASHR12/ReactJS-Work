Flow of Application should be this :

1. We will have total 6 pages [About,Cocktail,Error,HomeLayout,Landing,Newletter (all file as jsx)] , so create all pages under src/pages and use index.js to export all.
2. Use Homelayout for layout the entire application and Landing page will be the page which will be displayed as root "/"
3. We will have header component with logo and nav links which will be available on all the pages so make sure to use proper routing nesting.
4. Create all the components under src/components for example Navbar.jsx
